...
export const KEYBOARD_MAP = new Map<string,KeyData>( 
    [
        ...
        ["idkbd101",new KeyData({en:"1",enH:"!",he:"1",ar:"١",ru:"1",ruH:"!",isLast:false,isChar:true})],
        ["idkbd102",new KeyData({en:"2",enH:"@",he:"2",ar:"٢",ru:"2",ruH:"@",isLast:false,isChar:true})],
        ["idkbd103",new KeyData({en:"3",enH:"#",he:"3",ar:"٣",ru:"3",ruH:"#",isLast:false,isChar:true})],
        ["idkbd104",new KeyData({en:"4",enH:"$",he:"4",ar:"٤",ru:"4",ruH:"$",isLast:false,isChar:true})],
        ["idkbd105",new KeyData({en:"5",enH:"%",he:"5",ar:"٥",ru:"5",ruH:"%",isLast:false,isChar:true})],
        ["idkbd106",new KeyData({en:"6",enH:"^",he:"6",ar:"٦",ru:"6",ruH:"^",isLast:false,isChar:true})],
        ["idkbd107",new KeyData({en:"7",enH:"&",he:"7",ar:"٧",ru:"7",ruH:"&",isLast:false,isChar:true})],
        ["idkbd108",new KeyData({en:"8",enH:"*",he:"8",ar:"٨",ru:"8",ruH:"*",isLast:false,isChar:true})],
        ["idkbd109",new KeyData({en:"9",enH:"(",he:"9",ar:"٩",ru:"9",ruH:"(",isLast:false,isChar:true})],
        ["idkbd110",new KeyData({en:"0",enH:")",he:"0",ar:"٠",ru:"0",ruH:")",isLast:false,isChar:true})],
